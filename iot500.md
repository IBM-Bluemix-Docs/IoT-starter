...
June 22, 2018 Update -- It's not clear whetheer start_iot.md is in use anymore. In the main IoT Platform documentation, this topic seems to have replaced it: https://console.bluemix.net/docs/services/IoT/getting-started.html#getting-started-with-iotp
-->
